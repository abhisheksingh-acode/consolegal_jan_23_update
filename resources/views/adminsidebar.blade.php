    ...
    <div class="sidebar-wrapper sidebar-theme">
       ...
       <nav id="sidebar">
          <ul class="list-unstyled menu-categories ps ps--active-y" id="accordionExample">
             ...
             <!-- <li class="menu">
                <a href="#authentication1" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                   <div class="">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users">
                         <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                         <circle cx="9" cy="7" r="4"></circle>
                ...
                <ul class="collapse submenu list-unstyled" id="authentication1" data-parent="#accordionExample">
                   <li>
                      <a href="/admin/fran/add" target="_blank">Add Franchise </a>
                   </li>
                   <li>
                      <a href="/admin/fran/all" target="_blank">All Franchise </a>
                   </li>
