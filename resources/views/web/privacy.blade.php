...
@section('title','Consolegal | Privacy Policy')

@section('content')
<!-- content section  -->
<section class="content-section row mx-auto container-md px-0">
   <h1 class="title text-center py-4">Privacy Policy</h1>
   <div class="container-md col-md-12 mx-auto py-5 ">
      <p class="para">
         Thank you for choosing to be part of our community at ConsoLegal.  We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice or our practices with regard to your personal information, please contact us at mail@consolegal.com
      </p>
      <p class="para">
         ...
         <ul>
             ...
             <li><b>"Website,"</b> we are referring to our website i.e., consolegal.com</li>
             <li><b>"Services,"</b> we are referring to the services that are listed on our Website.</li>
         </ul>
      </p>
      <p class="para">
      ...
      <li>
          ...
          <p class="para">
              Payment  Data. We may collect data necessary to process your payment if you have taken services, such as your payment instrument number (such as a credit card number), and the security code associated with your payment instrument. All payment data is stored by Razorpay payment gateway. You may find their privacy notice link(s) here:  razorpay.com/privacy
          </p>
          <p class="para">
    ...
    <li>
        ...
        <ul>
            ...
            <li><b>To post testimonials</b>We may use your information to request feedback and to contact you about your use of our Website. </li>
            ...
            <li><b>Fulfil and manage your orders</b>We may use your information to fulfil and manage your orders, payments, returns, and exchanges made through the Website.</li>
    ...
    <li>
        ...
        <p class="mt-3"><b>WILL YOUR INFORMATION BE SHARED WITH ANYONE?</b></p>
        <p class="para">
    ...
    <li>
        ...
        <p class="mt-3"><b>HOW DO WE HANDLE YOUR SOCIAL LOGINS?</b></p>
        <p class="para">
...
We will use the information we receive only for the purposes that are described in this privacy notice or that are otherwise made clear to you on the relevant Website. Please note that we do not control, and are not responsible for, other uses of your personal information by your third-party social media provider. We recommend that you review their privacy notice to understand how they collect, use and share your personal information, and how you can set your privacy preferences on their sites and apps.
    ...
    <li>
        ...
        <p class="mt-3"><b>HOW DO WE KEEP YOUR INFORMATION SAFE?</b></p>
        <p class="para">
    ...
    <li>
        ...
        <p class="mt-3"><b>WHAT ARE YOUR PRIVACY RIGHTS?</b></p>
        <p class="para">
           You may review, change, or terminate your account at any time.  
        </p>
        <p class="para">
            <a href="javascript:void(0)" class="text-dark">Account Information</a> <br />
        ...
        <ul>
            ...
            <li><b>Opting out of email marketing: </b>You can unsubscribe from our marketing email list at any time by clicking on the unsubscribe link in the emails that we send or by contacting us using the details provided below. You will then be removed from the marketing email list — however, we may still communicate with you, for example to send you service-related emails that are necessary for the administration and use of your account, to respond to service requests, or for other non-marketing purposes. To otherwise opt-out, you may: </li>
            <li>Contact us using the contact information provided.</li>
        </ul>
    </li>
    <li>
        <p class="mt-3"><b>CONTROLS FOR DO-NOT-TRACK FEATURES</b>
    ...
    <li>
        <p class="mt-3"><b>DO WE MAKE UPDATES TO THIS NOTICE? </b>
...
We may update this privacy notice from time to time. The updated version will be indicated by an updated "Revised" date and the updated version will be effective as soon as it is accessible. If we make material changes to this privacy notice, we may notify you either by prominently posting a notice of such changes or by directly sending you a notification. We encourage you to review this privacy notice frequently to be informed of how we are protecting your information.
    ...
    <li>
        <p class="mt-3"><b>HOW CAN YOU CONTACT US ABOUT THIS NOTICE? </b>
If you have questions or comments about this notice, you may email us at <b>mail@consolegal.com</b> or by post to: 
<address class="fw-bold">
ConsoLegal <br >
C32/22, B1/3, Annapurna Nagar Colony, <br />
Vidyapith Road, Varanasi, U.P-221002
</address>
        </p>
    </li>
    <li>
        <p class="mt-3"><b>HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU? </b>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please submit a request form.
