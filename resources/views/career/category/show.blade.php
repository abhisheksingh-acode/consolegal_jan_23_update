...
<div class="main-container" id="container">
   ...
   <div id="content" class="main-content">
      <div class="addform-page addorder">
         ...
         <form action="{{route('career.category.update',['id' =>  $data->id])}}" method="post">
            @csrf
            ...
            <div class="form-group">
               ...
               <input type="text" class="form-control" placeholder="category name" value="{{$data->category_name??''}}" name="category_name" required>
            </div>
            ...
            <div class="form-group">
               ...
               <input type="text" class="form-control" value="{{$data->location??''}}" placeholder="Available Location" name="location" required>
            </div>
